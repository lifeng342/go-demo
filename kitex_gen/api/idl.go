...
type Hello interface {
	...
	Hello(ctx context.Context, req string) (r string, err error)
}
...
func (p *HelloHelloArgs) GetReq() (v string) {
	return p.Req
}
func (p *HelloHelloArgs) SetReq(val string) {
	p.Req = val
}
...
func (p *HelloHelloArgs) Field1DeepEqual(src string) bool {
...
var HelloHelloResult_Success_DEFAULT string

func (p *HelloHelloResult) GetSuccess() (v string) {
	if !p.IsSetSuccess() {
...
func (p *HelloHelloResult) Field0DeepEqual(src *string) bool {
